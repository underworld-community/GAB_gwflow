...
if HPC_run == True:
    simulation_directory = "MH_timingTest_{}dx-{}dy-{}dz".format(dx/1e3, dy/1e3, dz/1e3) + "{}PPC/".format(GPC**3)
else:
...
# ### metropolis hastings
res = metropolis_hastings(func=forward_model, x0=x, nsim=10, burnin=0, x_scale=0.5*np.ones_like(x), )
